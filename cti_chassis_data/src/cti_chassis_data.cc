...
void CtiFpgaData::new_lin_ult_data_v3_0_Callback(
  ...
  for ( int i{0};i<4;i++) {
    alt_V_3_0_msg.header.frame_id = new_ult_name_v3_0[i] + "_id";
    alt_V_3_0_msg.range = msg->ori_datas.data[i];
    new_lin_ult_v3_0_pub[i]->publish(alt_V_3_0_msg);
  }

  alt_V_3_0_msg.header.frame_id = "front_center_ult_id";
  ...
  alt_V_3_0_msg.header.frame_id = "back_center_ult_id";
