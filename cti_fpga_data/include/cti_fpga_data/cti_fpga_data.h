...
public:
    ...
    void navigationlog_Callback(const cti_fpga_serial_msgs::msg::NavigationLog::SharedPtr msg);
    void chassisInfo_Callback(const cti_fpga_serial_msgs::msg::VehicleState::SharedPtr msg);
    ...
    void new_lin_ult_data_v3_0_Callback(const cti_fpga_serial_msgs::msg::UltV30Datas::SharedPtr msg);
    ...
    rclcpp::Subscription<cti_fpga_serial_msgs::msg::NavigationLog>::SharedPtr navigation_log_sub;
    rclcpp::Publisher<cti_msgs::msg::BoxState>::SharedPtr  rfid_pub;
    rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr  box_exist_pub;
    rclcpp::Subscription<cti_fpga_serial_msgs::msg::VehicleState>::SharedPtr chassis_info_sub;
    ...
    rclcpp::Subscription<cti_fpga_serial_msgs::msg::UltV30Datas>::SharedPtr new_lin_ult_data_v3_0_sub;
