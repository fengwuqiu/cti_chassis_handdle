...
CtiFpgaData::CtiFpgaData() : Node("cti_fpga_data_node") {
  boxloadstatus_old = 9;
  RFIDTIMEOUT_DUR = 6;
  boxloadid_old = "";
  rfid4th_old = "";
  ...
  chassis_error_sub =
      this->create_subscription<std_msgs::msg::UInt32MultiArray>(
          ...
          std::bind(&CtiFpgaData::chassiserror_Callback, this,
                    std::placeholders::_1));
  navigation_log_sub =
      this->create_subscription<cti_fpga_serial_msgs::msg::NavigationLog>(
          "/cti/fpga_serial/navigation_log", 2,
          std::bind(&CtiFpgaData::navigationlog_Callback, this,
                    std::placeholders::_1));
  chassis_info_sub =
      this->create_subscription<cti_fpga_serial_msgs::msg::VehicleState>(
  ...
  new_lin_ult_data_v3_0_sub =
      this->create_subscription<cti_fpga_serial_msgs::msg::UltV30Datas>(
...
/**********************************
 *new3.0超声波。 消息类型:cti_fpga_serial_msgs::msg::UltV30Datas::SharedPtr
 ***********************************/
void CtiFpgaData::new_lin_ult_data_v3_0_Callback(
    const cti_fpga_serial_msgs::msg::UltV30Datas::SharedPtr msg) {
...
/**********************************
 *底盘错误回调函数。 消息类型:cti_fpga_serial_msgs/chassiserrorcode
 ***********************************/
...
void CtiFpgaData::navigationlog_Callback(
    const cti_fpga_serial_msgs::msg::NavigationLog::SharedPtr msg) {
...
/**********************************
 *底盘信息log回调函数。 消息类型:cti_fpga_serial_msgs/vehicelstate
 ***********************************/
void CtiFpgaData::chassisInfo_Callback(
    const cti_fpga_serial_msgs::msg::VehicleState::SharedPtr msg) {
