...
class ChassisHanddle : public rclcpp::Node {
 ...
 private:
  ...
  void common_error_clear_callback(const std_msgs::msg::UInt64MultiArray::SharedPtr msg);  // 清空错误码
  ...
  rclcpp::Subscription<std_msgs::msg::UInt64MultiArray>::SharedPtr common_error_clear_sub;;  // 错误码清空  
