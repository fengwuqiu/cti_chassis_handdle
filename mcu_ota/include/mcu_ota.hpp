...
private:
    ...
    rclcpp::Subscription<cti_fpga_serial_msgs::msg::UpdateInfo>::SharedPtr manager_sub;

    void ros_recv_data_call_back(const cti_fpga_serial_msgs::msg::UpdateInfo::SharedPtr msg);
    ...
    rclcpp::Publisher<cti_fpga_serial_msgs::msg::UpdateInfo>::SharedPtr manager_pub;
